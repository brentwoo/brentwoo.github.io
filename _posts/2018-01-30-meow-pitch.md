...
<img src="{{ site.url }}/assets/img/kuma.JPG" style="float:right; width:170px;   border-radius: 100%; ">
...
<audio controls>
  <source src="{{ site.url }}/assets/img/total-pitch.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
<center><img src="{{ site.url }}/assets/img/total-pitch.png" style="width:780px; height:auto"></center>
...
<audio controls>
  <source src="{{ site.url }}/assets/img/kuma-pitch.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
<audio controls>
  <source src="{{ site.url }}/assets/img/me-pitch.mp3" type="audio/mpeg">
</audio>
<center><img src="{{ site.url }}/assets/img/kuma-me-pitch.png" style="width:780px; height:auto"></center>
...
<audio controls>
  <source src="{{ site.url }}/assets/img/recorder-cis-pitch.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
<center><img src="{{ site.url }}/assets/img/recorder-cis-pitch.png" style="width:350px; height:auto"></center>
...
<audio controls>
  <source src="{{ site.url }}/assets/img/kuma-down.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
<center><img src="{{ site.url }}/assets/img/kuma-down.png" style="width:350px; height:auto"></center>
